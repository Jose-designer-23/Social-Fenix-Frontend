...
const EditProfileForm: React.FC<EditProfileFormProps> = ({ onSave }) => {
    ...
    return (
        <div className="max-w-xl mx-auto p-4">
            <h1 className="text-3xl font-extrabold mb-6 text-gray-900">🐦‍🔥 Editar Perfil</h1>
            <form onSubmit={handleSubmit} className="bg-white p-6 shadow-xl rounded-lg space-y-4">
                <div>
                ...
                <div>
                    <label htmlFor="biografia" className="block text-sm font-semibold text-gray-700 mb-1">Biografía</label>
                    <textarea 
                        id="biografia"
                        name="biografia" 
                ...
                <div>
                    <label htmlFor="url" className="block text-sm font-semibold text-gray-700 mb-1">URL (Enlace)</label>
                    <input 
                        id="url"
                        type="url" 
                        name="url" 
                ...
                <button 
                    type="submit" 
                    disabled={isSaving} 
                    className="w-full bg-indigo-600 text-white py-3 rounded-full text-lg font-bold disabled:bg-gray-400 transition duration-150"
                >
