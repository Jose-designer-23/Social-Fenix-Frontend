  ...
  const scrollToLanding = () => {
    ...
    if (!el) {
      ...
      if (currentSlide < lastIndex) {
        if (
          landingRef.current &&
          typeof landingRef.current.next === "function"
        ) {
    ...
    if (!isVisible) {
      ...
      if (
        landingRef.current &&
        typeof landingRef.current.openAndShowFirst === "function"
      ) {
        try {
  ...
  return (
    <>
      ...
      {!landingVisible && (
        ...
        <div
          className="
            fixed z-50 pointer-events-none flex flex-col items-center gap-2
            right-4 bottom-4
        ...
        >
          <div className="text-center flex flex-col items-center">
            ...
            <p className="text-white text-md font-bold select-none hidden lg:block">
          ...
          <button
            aria-label={
              currentSlide < 4 ? "Ver características" : "Volver al inicio"
            }
